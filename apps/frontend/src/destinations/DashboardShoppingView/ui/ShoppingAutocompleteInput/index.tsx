...
interface ShoppingAutocompleteInputProps {
  value: string
...
const ShoppingAutocompleteInput: FC<ShoppingAutocompleteInputProps> = ({
  value,
  onChange,
  onSubmit,
  autoFocus = false,
  ...
  return (
    <Autocomplete
      ...
      filter={({ options, search }) => {
        ...
        const searchValue =
          colonIndex !== -1 ? search.substring(0, colonIndex).trim() : search.trim()
...
export default ShoppingAutocompleteInput
